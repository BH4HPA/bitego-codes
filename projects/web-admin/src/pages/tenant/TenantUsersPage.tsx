...
export function TenantUsersPage() {
  ...
  const q = useQuery({
    queryKey: ['tenant_users', userType, keyword, page, rowsPerPage],
    queryFn: () =>
      listTenantUsers({
        userType,
    ...
    <Box>
      ...
      {tenantId ? (
        <>
          <AddMemberDialog
            open={addOpen}
            scope={{ kind: 'tenant', tenantId, tenantType }}
          ...
          <UserDetailDrawer
            ...
            userId={detailUserId || ''}
            context={{ kind: 'tenant', tenantId, tenantType }}
            invalidateKey={['tenant_users']}
